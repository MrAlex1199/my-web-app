...
export default function Cart() {
    return (
        <div className="card rounded-lg shadow-md mt-5 mx-10 bg-white">
            <div class=" relative z-10 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 after:bg-gray-50">
                    ...
                    <div class="grid grid-cols-12">
                        <div
                            ...
                            <div class="flex items-center justify-between pb-8 border-b border-gray-300">
                                ...
                                <h2 class="font-manrope font-bold text-3xl leading-10 text-black">3 Items</h2>
                            </div>
                            ...
                            <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center gap-5 py-6  border-b border-gray-200">
                                <div class="w-full md:max-w-[126px]">
                                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-02-secondary-product-shot.jpg" alt="perfume bottleimage" class="mx-auto"/>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                                    <div class="md:col-span-2">
                                        <div class="flex flex-col max-[500px]:items-center gap-3">
                                            ...
                                            <h6 class="font-semibold text-base leading-7 text-indigo-600">$120.00</h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                                        <p class="font-bold text-lg leading-8 text-indigo-600 text-center">$120.00</p>
                                    </div>
                                </div>
                            </div>
                            <div
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                                    ...
                                    <div class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                                        <p class="font-bold text-lg leading-8 text-indigo-600 text-center">$240.00</p>
                                    </div>
                                </div>
                            </div>
                            <div
                                class="flex flex-col min-[500px]:flex-row min-[500px]:items-center gap-5 py-6  border-b border-gray-200">
                                <div class="w-full md:max-w-[126px]">
                                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-02-secondary-product-shot.jpg" alt="perfume bottleimage"
                                        class="mx-auto"/>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-4 w-full">
                                    <div class="md:col-span-2">
